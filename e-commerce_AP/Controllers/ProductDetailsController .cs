...
namespace e_commerce_AP.Controllers
{
    ...
    {
        private readonly ECommerce_APDbContext _context; // ApplicationDbContext là DbContext của bạn

        public ProductDetailsController(ECommerce_APDbContext context)
        {
            _context = context;
        }

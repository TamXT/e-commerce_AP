...
namespace e_commerce_AP.Common
{
    public class Common
    {


        private static string password = System.Configuration.ConfigurationManager.AppSettings["PasswordEmail"];
        private static string Email = System.Configuration.ConfigurationManager.AppSettings["Email"];

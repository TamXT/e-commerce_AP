...
namespace e_commerce_AP.Data
{
    public partial class ECommerce_APDbContext : IdentityDbContext<IdentityUser>
    {
        public ECommerce_APDbContext(DbContextOptions<ECommerce_APDbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=TAMXT\\SQLSERVER2022;Initial Catalog=e_commerce_AP_V2;Integrated Security=True;Encrypt=False"); // Use your actual connection string here

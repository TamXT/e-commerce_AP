...
namespace e_commerce_AP.Services.Momo
{
    public class MomoService : IMomoService
    {
        ...
        public async Task<MonoCreatePaymentResponseModel> CreatePaymentMomo(OrderInfo model)
        {
            ...
            return JsonConvert.DeserializeObject<MonoCreatePaymentResponseModel>(response.Content);

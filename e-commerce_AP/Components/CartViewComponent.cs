...
namespace e_commerce_AP.Components
{
    ...
    {
        private readonly ECommerce_APDbContext _context; // Thay thế ApplicationDbContext bằng context của bạn

        public CartViewComponent(ECommerce_APDbContext context)
        {
            _context = context;
        }
